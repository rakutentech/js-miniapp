...
var MiniAppBridge = /** @class */ (function () {
    ...
    MiniAppBridge.prototype.sendMessageToContactId = function (id, message) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            return _this.executor.exec('sendMessageToContact', { contactId: id, messageToContact: message }, function (messageId) { return resolve(messageId); }, function (error) { return reject(error); });
        });
    };
