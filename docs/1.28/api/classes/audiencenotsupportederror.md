...
*Defined in [js-miniapp-bridge/src/types/error-types/auth-errors.ts:9](https://github.com/rakutentech/js-miniapp/blob/5bf7443/js-miniapp-bridge/src/types/error-types/auth-errors.ts#L9)*
...
*Defined in [js-miniapp-bridge/src/types/error-types/auth-errors.ts:10](https://github.com/rakutentech/js-miniapp/blob/5bf7443/js-miniapp-bridge/src/types/error-types/auth-errors.ts#L10)*
