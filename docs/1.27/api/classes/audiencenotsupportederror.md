...
*Defined in [js-miniapp-bridge/src/types/error-types/auth-errors.ts:9](https://github.com/rakutentech/js-miniapp/blob/53049ef/js-miniapp-bridge/src/types/error-types/auth-errors.ts#L9)*
...
*Defined in [js-miniapp-bridge/src/types/error-types/auth-errors.ts:10](https://github.com/rakutentech/js-miniapp/blob/53049ef/js-miniapp-bridge/src/types/error-types/auth-errors.ts#L10)*
