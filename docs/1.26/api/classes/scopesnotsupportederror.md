...
*Defined in [js-miniapp-bridge/src/types/error-types/auth-errors.ts:17](https://github.com/rakutentech/js-miniapp/blob/759cace/js-miniapp-bridge/src/types/error-types/auth-errors.ts#L17)*
...
*Defined in [js-miniapp-bridge/src/types/error-types/auth-errors.ts:18](https://github.com/rakutentech/js-miniapp/blob/759cace/js-miniapp-bridge/src/types/error-types/auth-errors.ts#L18)*
