...
* [Error](miniapperror.md#error)
  ...
  ↳↳ [InternalBrowserError](internalbrowsererror.md)

  ↳↳ [SimCheckError](simcheckerror.md)
...
*Defined in [js-miniapp-bridge/src/types/error-types/mini-app-error.ts:9](https://github.com/rakutentech/js-miniapp/blob/939c227/js-miniapp-bridge/src/types/error-types/mini-app-error.ts#L9)*
