...
*Defined in [js-miniapp-bridge/src/types/error-types/auth-errors.ts:25](https://github.com/rakutentech/js-miniapp/blob/939c227/js-miniapp-bridge/src/types/error-types/auth-errors.ts#L25)*
...
*Defined in [js-miniapp-bridge/src/types/error-types/auth-errors.ts:26](https://github.com/rakutentech/js-miniapp/blob/939c227/js-miniapp-bridge/src/types/error-types/auth-errors.ts#L26)*
