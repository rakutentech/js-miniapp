...
The data format must match the [ShareInfoType](api/interfaces/shareinfotype.html).
...
The support screen change cases are defined as [ScreenOrientation](api/enums/screenorientation.html).
