...
| `CustomPermissionName.ATTACHMENTS` | Allow miniapp to download attachments. |
...
miniApp.requestCustomPermissions([
    ...
    {name: CustomPermissionName.ATTACHMENTS, description: 'This text will be shown to the user.'},
]).then((result) => {
